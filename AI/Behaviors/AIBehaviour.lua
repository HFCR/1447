...
AIBehaviour = {
	...
	AVAILABLE = {
		...
		Job_PatrolMulti	= "Scripts/AI/Behaviors/Personalities/SHARED/Jobs/Job_PatrolMulti.lua",
...
--		HeliAssaultIdle			= "Scripts/AI/Behaviors/Vehicles/Helicopter/Heli_idle.lua",		
		...
		ZombieIdle		= "Scripts/AI/Behaviors/Personalities/Zombie/ZombieIdle.lua",
		ZombieAttack		= "Scripts/AI/Behaviors/Personalities/Zombie/ZombieAttack.lua",
