...
--   and friendly cover NPCs' combat
...
AIBehaviour.CoverAttack = {
	...
	if (sender==_localplayer) or (entity.Properties.species==0) then 
	entity:SelectPipe(0,"retaliate_damage",sender.id); end
	end end
	end,

	OnLeftLean  = function( self, entity, sender)
	if (entity.Properties.KEYFRAME_TABLE~="VALERIE") then 
	...
	if (entity.Properties.KEYFRAME_TABLE~="VALERIE") then
	entity:SelectPipe(0,"dig_in_attack"); end
	end,
