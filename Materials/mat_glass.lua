...
Materials["mat_glass"] = {
	...
	melee_punch = {
		sounds = {
			{"Sounds/Bullethits/bglass2.wav",SOUND_UNSCALABLE,200,5,60,{fRadius=10,fInterest=1,fThreat=0,},},
			{"Sounds/Bullethits/bglass3.wav",SOUND_UNSCALABLE,200,5,60,{fRadius=10,fInterest=1,fThreat=0,},},
 		},
	},
