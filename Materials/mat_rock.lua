...
-------------------------------------
	...
	melee_punch = {
		sounds = {
			{"Sounds/Bullethits/bleaves1.wav",SOUND_UNSCALABLE,185,5,30,{fRadius=10,fInterest=1,fThreat=0,},},
		},
	},
	melee_slash = {
		sounds = {
	...
	melee_clash = {
		sounds = {
			{"objects/weapons/machete_mod/mclash1.wav",SOUND_UNSCALABLE,185,5,30,{fRadius=10,fInterest=0,fThreat=1,},},
			{"objects/weapons/machete_mod/mclash2.wav",SOUND_UNSCALABLE,185,5,30,{fRadius=10,fInterest=0,fThreat=1,},},
		},
		particleEffects = {
