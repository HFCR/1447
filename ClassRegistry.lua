...
System.this_mod_version = "$17.7.7.7";
EntityClassRegistry = 
{
-- entity_type,name,ID,script_file
--
	{"Player",		"Player",PLAYER_CLASS_ID,"#rrt1442-----/rrts.lua"},							--  1
	...
	{"Pickup",		"PickupEngineerTool",38,"Pickups/PickupEngineerTool.lua"}, 							-- 38
	{"Pickup",		"PickupM249",39,"Pickups/PickupM249.lua"}, 									-- 39

	{"Pickup",		"PickupGlock17",851,"Pickups/PickupGlock17.lua"},
	{"Pickup",		"PickupP99",401,"Pickups/PickupP99.lua"}, 
        {"Pickup",	"PickupScubaGear", 925, "Pickups/PickupScubaGear.lua" },
	{"Pickup",      "PickupChaingun",208,"Pickups/PickupChaingun.lua"},
 		
	{"Pickup",		"PickupSteyr",402,"Pickups/PickupSteyr.lua"},
	{"Pickup",		"PickupM3",404,"Pickups/PickupM3.lua"},
	{"Pickup",		"PickupDUALMP7",406,"Pickups/PickupDUALMP7.lua"},	
	{"Pickup",		"PickupSopmod",407,"Pickups/PickupSopmod.lua"},							
	...
	{"Player",		"Zombie",		82,"AI/Zombie.lua"},																-- 82
	...
	{ "",	"DirrectorWorld",	200,	"World/ClearingWorldDirector.lua" },
	...
	{ "",	"ClearingCreatureGenerator",						6192,	"Clearing/ClearingCreatureGenerator.lua" },		
	{ "",	"ClearingMissionTrigger",							6193,	"Clearing/ClearingMissionTrigger.lua" },				
        { "",	"Synched2DTable",	SYNCHED2DTABLE_CLASS_ID,	"multiplayer/Synched2DTable.lua" },							-- 205 used to syncronize scoreboard in multiplayer
	{ "",	"NpcDialogText",	206,	"Triggers/NpcDialogText.lua" },
	{"Projectile","ThrowMachete",209,"Weapons/ThrowMachete.lua"},
	{ "",	"ProximityNumberTrigger",	210,	"Triggers/ProximityNumberTrigger.lua" },
	{"",	"Ai_Creator",	211,	"AI/Ai_Creator.lua"},
	{"Vehicle",	"quad",	212,	"Vehicles/quad.lua"},
	{"Player",		"SentryDEF",213,"AI/SentryDEF.lua"},
	{"Vehicle", "JetVehicle",214,"Vehicles/JetVehicle.lua"},
	{ "",	"BuyObject",	215,	"World/BuyObject.lua" },
	{ "",	"MissionHintMusic",	216,	"Sound/MissionHintMusic.lua" },
	{"Pickup",	"PickupBandage",223,"Pickups/PickupBandage.lua"},
	{"Pickup",		"PickupA2000",224,"Pickups/PickupA2000.lua"}, 										-- 29
	{"Projectile","PlasmaBall",225,"Weapons/PlasmaBall.lua"},
	{ "",	"BgmMusicLoop",	227,	"Sound/BgmMusicLoop.lua" },
	{"Vehicle",		"Kawasaki_Ultra150_std",	 228,"Vehicles/Kawasaki_Ultra150_std.lua"},
	{"Pickup",		"PickupVector",233,"Pickups/PickupVector.lua"},
	{"Pickup",		"PickupVodka",235,"Pickups/PickupVodka.lua"},
	{"Pickup",		"PickupYoghurt",236,"Pickups/PickupYoghurt.lua"},
	{"Player",		"OpasniyPozik",	237,"AI/OpasniyPozik.lua"},
	{ "Pickup",		"PickupSilencer",	238,	"Pickups/PickupSilencer.lua" },
	{ "Pickup",		"PickupM1911",	239,	"Pickups/PickupM1911.lua" },
	{"Projectile",	"x850Grenade",240,"Weapons/X850Grenade.lua"},
	{"Pickup",	"PickupRPG7",241,"Pickups/PickupRPG7.lua"},
	{"Pickup",	"PickupMeat",244,"Pickups/PickupMeat.lua"},
	{ "",	"HudTexgen",	245,	"Triggers/HudSigns.lua" },
	{"Pickup",	"PickupKatana",249,"Pickups/PickupKatana.lua"},
	{"Pickup",	"PickupOC14",251,"Pickups/PickupOC14.lua"},
	{"Pickup",	"PickupFAMAS",252,"Pickups/PickupFAMAS.lua"},
	{ "",	"VehicleRadio",	253,	"World/VehicleRadio.lua" },
        {"Pickup",	"PickupMedicTool",254,"Pickups/PickupMedicTool.lua"},
	{"Projectile",		"RPG7_rocket"		,261,	"Weapons/RPG7_rocket.lua"},
		{ ""	,		"AmmoRPG7"		,262,	"Pickups/AmmoRPG7.lua" },
	{"Pickup",	"PickupScoutTool",255,"Pickups/PickupScoutTool.lua"},
	{"Pickup",	"PickupShotgunDB",264,"Pickups/PickupShotgunDB.lua"}, 
};
