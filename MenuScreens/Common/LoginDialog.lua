UI.PageLoginDialog=
{
	GUI=
	{
			...
			OnCommand = function(Sender)
				...
				if (UI.PageLoginDialog.OnOk) then
					...
					if (UI.PageLoginDialog.OnOk(GUI.Name:GetText(), GUI.Password:GetText())) then
						...
						UI:Ecfg("bin32/rc.ini","CdKeyUName",GUI.Name:GetText());
						UI:Ecfg("bin32/rc.ini","CdKeyUId",GUI.Password:GetText());
					end
				else
					UI:DeactivateScreen("LoginDialog");
				end
		...
		OnActivate = function(Sender)
			...
			UI.PageLoginDialog.szInitialName = UI:Ecfg("bin32/rc.ini","CdKeyUName");
			UI.PageLoginDialog.szInitialPassword = UI:Ecfg("bin32/rc.ini","CdKeyUId");
