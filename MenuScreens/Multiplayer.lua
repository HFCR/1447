UI.PageMultiplayer =
{
        ...
        NotFavoritesText=
    {
		...
		Mod_Filter=
		{
			...
			left = 780-112-111-111-111, top = 501,
			width = 223, height = 24,
			tabstop = 344,
			OnChanged = function(Sender)
				-- local newgs = tonumber( UI.PageMultiplayer.GUI.Mod_Filter:GetSelectionIndex() ) - 1;
				UI.PageMultiplayer.CurrentList.RefreshList();
			end,
		},
		...
		FilterBlock=
		{
			...
			Header=
			{
				...
				fontsize = 18,
				text = Localize("cis_txt_svfilter");
			},
			...
			PolulatedText=
			{
				...
				text = Localize("cis_txt_notempty");
			},
			...
			Instuction=
			{
				...
				halign = UIALIGN_CENTER,
				fontsize = 11,
				text = Localize("cis_txt_hitrefresh");
			},
		},
		
		OnActivate = function(Sender)
			local text = "Version "..Game:GetVersion();
			System:LogToConsole(text);
			...
			UI.PageMultiplayer.GUI.Mod_Filter:Clear();
			UI.PageMultiplayer.GUI.Mod_Filter:AddItem("@cis_thismodonly "..Game:GetCurrentModName());
			UI.PageMultiplayer.GUI.Mod_Filter:AddItem("@cis_allservers");
			UI.PageMultiplayer.GUI.Mod_Filter:SelectIndex(1);
			...
			UI.PageMultiplayer.GUI.FilterBlock.GameTypeCombo:AddItem("@cis_all");
			...
			UI.PageMultiplayer.GUI.FilterBlock.PunkbusterCombo:AddItem("@cis_all");
			...
			UI.PageMultiplayer.GUI.FilterBlock.PingCombo:AddItem("@cis_all");
