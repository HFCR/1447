...
function UI:OnInit()
	...
	UI.EnterFrame_Sound = Sound:LoadSound("Sounds/EnterFrame_Sound.wav");
	UI.Hover_Sound = Sound:LoadSound("Sounds/Hover_Sound.wav");
	-- Load Music
	...
	Script:LoadScript(szScriptFolder.."Ingame/InGameWorld.lua", 1);
