...
MultiplayerClassDefiniton=
{
	PlayerClasses={			-- for class based mods
		...
		Grunt=
		{
			...
			weapon1={"Machete",},
			weapon2={"Falcon","P99"},
			weapon3={"P90","Shotgun","M3","vector"},
			weapon4={"AG36","OICW","M249","P416"},
			primaryWeaponSlot=4,
			...
			move_params = {
				speed_run=MCD_Scale*3.4*RunSpeedMult,
				speed_walk=MCD_Scale*1.9*gr_walkspeed_factor,
				speed_swim=MCD_Scale*2.6*gr_swimspeed_factor,
		...
		lean_angle=14.0,
		bob_pitch=0.147101101,
		bob_roll=0.1774178,
		bob_lenght=3.8*MCD_Scale,
		bob_weapon=0.0147/MCD_Scale,
			},
		...
		Sniper=
		{
			...
			weapon2={"Falcon","MP5","vector","m1911"},
			weapon3={"SniperRifle", "RL","VSS"},
			weapon4={},
			primaryWeaponSlot=2,
		...
		Support=
		{
			...
			max_armor	= 40,
			fallscale = 0.94,
			weapon1={"Falcon","glock17"},			
			weapon2={"M4","MP5","an94","Steyr"},
			weapon3={"ScoutTool","MedicTool","Bow"},
	...
	DefaultMultiPlayer=				-- team or non team mods
	{
		...
		move_params = {
			speed_run=MCD_Scale*3.0*RunSpeedMult,
			speed_walk=MCD_Scale*1.5*gr_walkspeed_factor,
			speed_swim=MCD_Scale*2.5*gr_swimspeed_factor,
			speed_crouch=MCD_Scale*1.5*gr_crouchspeed_factor,
                        speed_prone=MCD_Scale*0.6*gr_pronespeed_factor,
			jump_force=MCD_Scale*7.3*gr_jumpforce_factor,
		lean_angle=9.0,
		bob_pitch=0.147101101,
		bob_roll=0.1774178,
		bob_lenght=3.8*MCD_Scale,
