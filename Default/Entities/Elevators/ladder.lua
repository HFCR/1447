Ladder = {
  type = "Ladder",
	...
	Properties = {
		...
		fClimbSpeed = 1.8,
		Sounds = {
			sndFile1 = "sounds/player/footsteps/ladder/step1.wav",
			sndFile2 = "sounds/player/footsteps/ladder/step2.wav",
			sndFile3 = "sounds/player/footsteps/ladder/step3.wav",
			sndFile4 = "sounds/player/footsteps/ladder/step4.wav"
		},
	},
...
--			self:SetBBox(bbox.min, bbox.max);
	...
	self.ladder_sound = {
		Sound:Load3DSound(self.Properties.Sounds.sndFile1,0,160,1,100),
		Sound:Load3DSound(self.Properties.Sounds.sndFile2,0,160,1,100),
		Sound:Load3DSound(self.Properties.Sounds.sndFile3,0,160,1,100),
		Sound:Load3DSound(self.Properties.Sounds.sndFile4,0,160,1,100),
	};
	self.lastSound=nil;
end
-------------------------------------------------------
...
--		player.cnt:OverrideMoveParams(self.climb_move_params);
		player.cnt:UseLadder(1, self.Properties.fClimbSpeed, self:GetPos());
