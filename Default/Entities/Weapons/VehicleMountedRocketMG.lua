...
--	character	= "Objects/Vehicles/Mounted_gun/m2.cga",	
	...
	FireParams ={													-- describes all supported firemodes
	{
		...
		FireSounds = {
			"Sounds/Weapons/M4/m4single.wav",
			"Sounds/Weapons/M4/m4single.wav",
		},
		FireSoundsStereo = {
			"Sounds/Weapons/M4/m4single.wav",
...
if (Game:IsMultiplayer()) then
	function VehicleMountedRocketMG.Server:OnUpdate(delta, shooter)
		if (shooter.fireparams.projectile_class) and (toNumberOrZero(getglobal("gr_norl"))==1) then
			shooter.cnt.ammo_in_clip = 0;
			shooter.cnt.ammo = 0;
		end
