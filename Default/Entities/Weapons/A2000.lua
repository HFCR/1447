...
A2000 = {
	name			= "A2000",
	object		= "Objects/Weapons/A2000/A2000_bind.cgf",
	character	= "Objects/Weapons/A2000/A2000.cgf",

	---------------------------------------------------
	PlayerSlowDown = 0.88,									-- factor to slow down the player when he holds that weapon
	---------------------------------------------------
	ActivateSound = Sound:LoadSound("Sounds/Weapons/A2000/A2000_activate_stereo.wav",0,100),	-- sound to play when this weapon is selected
	---------------------------------------------------
	...
	
	{
		...
		silenced="Sounds/weapons/a2000/a_silent.wav",
		bullet_per_shot=1,
		bullets_per_clip=32,
		...
		TrailOff="Sounds/Weapons/A2000/A2000_MONO_TAIL.wav",
		TrailOffStereo="Sounds/Weapons/A2000/A2000_STEREO_TAIL.wav",
		...
		{	"reload1",	12,			Sound:LoadSound("Sounds/Weapons/A2000/OUT.wav",0,100)},
		--{	"reload1",	40,			Sound:LoadSound("Sounds/Weapons/A2000/A2000_2.wav",0,100)},
		{	"reload1",	49,			Sound:LoadSound("Sounds/Weapons/A2000/IN.wav",0,100)},
--		{	"swim",		1,				Sound:LoadSound("Sounds/player/water/underwaterswim2.wav",0,255)},
	},
}


CreateBasicWeapon(A2000);
