Salo = {
	name			= "Salo",
	object		= "objects/weapons/salo/vodka_hand.cgf",
	character	= "objects/weapons/salo/vodka_pickup.cgf",
		...
		-- describes all supported firemodes
	{
		...
		FireSounds = {
			"objects/weapons/salo/fire1.wav",
			},
		no_ammo=1,
...
function Salo.Server:OnFire( params )
...
function Salo.Server:OnActivate(Params)
	if Params.shooter then
...
function Salo.Client:OnActivate(Params)
...
function Salo.Server:OnUpdate(delta, shooter)	
