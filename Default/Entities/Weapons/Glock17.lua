Glock17 = {
	...
	name			= "Glock17",
	object		= "Objects/Weapons/Glock17/Glock17_bind.cgf",
	character	= "Objects/Weapons/Glock17/Glock17.cgf",

	PlayerSlowDown = 0.95,									-- factor to slow down the player when he holds that weapon
	---------------------------------------------------
	...
	{				-- used for choosing animation - is pistol 
		HasCrosshair=1,		
		min_recoil=0.3,
		max_recoil=0.6,
		AmmoType="Pistol",
...
--		fire_rate= 0.2, DE_org
		...
		FModeActivationTime = 0.1,
		fire_mode_type = FireMode_Instant,
		iImpactForceMul = 20,
		iImpactForceMulFinal = 45,
--		iImpactForceMul = 20,  		ORG
--		iImpactForceMulFinal = 65.02,	ORG
		...
		FireSounds = {
			"Sounds/Weapons/Glock17/leiser_einzel.wav",
                        "Sounds/Weapons/Glock17/leiser_einzel.wav",
			"Sounds/Weapons/Glock17/leiser_einzel.wav",
		},
		FireSoundsStereo = {
		...
		MuzzleFlashTPV = {
			geometry_name = "Objects/Weapons/Muzzle_flash/mf_DE_tpv.cgf", ---werden wir sehn --Matto
	...
	SoundEvents={
		...
		{	"reload1",	1,			Sound:LoadSound("Sounds/Weapons/DE/DEclipslap_38.wav",0,100)},
		{	"reload1",	11,			Sound:LoadSound("Sounds/Weapons/DE/DEclipout_10.wav",0,100)},
		{	"reload1",	37,			Sound:LoadSound("Sounds/Weapons/DE/DEclipin_25.wav",0,100)},
		{	"reload1",	52,			Sound:LoadSound("Sounds/Weapons/DE/DEclipslap_38.wav",0,100)},
