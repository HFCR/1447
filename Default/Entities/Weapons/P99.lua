function GetScopeTex()
	...
	if( cur_r_TexResolution >= 2 ) then -- lower res texture for low texture quality setting
		return System:LoadImage("Objects/Weapons/P99/zoom.dds");
	else
		return System:LoadImage("Objects/Weapons/P99/zoom.dds");
	end
end
...
P99 = {
	-- DESCRIPTION
	-- Default weapon, loud and does not travel far but does the job --leck mich
	name			= "P99",
	object		= "Objects/Weapons/P99/P99_bind.cgf",
	character	= "Objects/Weapons/P99/P99.cgf",
...
--		},
--		MuzzleFlashTPV = {
--			geometry_name = "Objects/Weapons/Muzzle_flash/mf_DE_tpv.cgf", ----MEGACHECK
...
--		},
	...
	SoundEvents={
		...
		{	"reload1",	10,			Sound:LoadSound("Sounds/Weapons/P99/P99_clipout.wav",0,100)},
		{	"reload1",	40,			Sound:LoadSound("Sounds/Weapons/P99/P99_clipin.wav",0,100)},
