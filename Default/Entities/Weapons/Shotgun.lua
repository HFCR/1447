Shotgun = {
	...
	character	= "Objects/Weapons/pancor_mod/pancor.cgf",
	
	PlayerSlowDown = 0.89,									-- factor to slow down the player when he holds that weapon
	---------------------------------------------------
	...
	FireParams ={													-- describes all supported firemodes
	{
		...
		silenced="Sounds/weapons/Shotgun/sh_silent.wav",
		distance=100,
...
--function Shotgun:DrawZoomOverlay( ZoomStep )
--	if ( Shotgun.ZoomBackgroundTID ) then
...
--		System:DrawImageColorCoords( Shotgun.ZoomBackgroundTID, 400, 600, 400+Hud.hdadjust*1.52, -600, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
--		System:DrawImageColorCoords( Shotgun.ZoomBackgroundTID, 400, 600, -400-Hud.hdadjust*1.52, -600, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, 400, 300, -400+Hud.hdadjust*1.52, 300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, 400, 300, 400-Hud.hdadjust*1.52, 300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
--		if (Hud.hdadjust > 0) then
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, Hud.hdadjust*1.52-700, 300, 700, -300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, Hud.hdadjust*1.52-700, 300, 700, 300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, 1500-Hud.hdadjust*1.52, 300, -700, -300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
	--	System:DrawImageColorCoords( P416.ZoomBackgroundTID, 1500-Hud.hdadjust*1.52, 300, -700, 300, 4, 1, 1, 1, 1, fTexelW, fTexelH, 1-fTexelW, 1-fTexelH);
--		end
--	end
