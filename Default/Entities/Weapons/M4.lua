M4 = {
	...
	character	= "Objects/Weapons/M4_mod/M4.cgf",
	...
	FireParams ={													-- describes all supported firemodes
	{
		...
		silenced="Sounds/Weapons/M4/sa35156.wav",
		...
		silenced="Sounds/Weapons/M4/sa35156.wav",
		FireSounds = {"Sounds/Weapons/m4/FINAL_M4_STEREO_SINGLE.wav"},
	...
	--SINGLE SHOT--------------------------------
	{
		...
		FireSounds = {
			"Sounds/Weapons/m4/FINAL_M4_STEREO_SINGLE.wav",
			"Sounds/Weapons/m4/FINAL_M4_STEREO_SINGLE.wav",
		},
		silenced="Sounds/Weapons/M4/sa35156.wav",
		-- recoil values
