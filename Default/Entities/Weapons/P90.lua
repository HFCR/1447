P90 = {
	...
	character	= "Objects/Weapons/P90_mod/P90.cgf",
	...
	{													-- describes all supported 	firemodes
	{
		...
		distance=600,
		damage=8, -- default = 8
		silenced="sounds/weapons/p90/p90_silent.wav",
	...
	--[[script activation function enable]]--
		FireSounds = {
			"Sounds/Weapons/p90/FINAL_P90_STEREO_LOOP.wav",
		},
		FireSoundsStereo = {
			"Sounds/Weapons/p90/FINAL_P90_STEREO_LOOP.wav",
		},
