ScoutTool = {
	...
	},
	{
		...
		type = 5,
		AmmoType="StickyExplosive",
		projectile_class="ProjProximityMine",
		ammo=50,
		reload_time=2.5,
		fire_rate=1.0,
		fire_activation=FireActivation_OnPress,
	...
	},
	{
		...
		type = 5,
		AmmoType="StickyExplosive",
		projectile_class="ProximityMine",
		ammo=50,
		reload_time=2.5,
		fire_rate=1.0,
		fire_activation=FireActivation_OnPress,
...
ScoutTool.anim_table[2]=ScoutTool.anim_table[1];
ScoutTool.anim_table[3]=ScoutTool.anim_table[1];