...
-----------------------------------------------------------------------------------------------------
	...
	VALERIE = {
		SoundEvents={
			...
			{"sreload", 7, Sound:Load3DSound("Sounds/Weapons/MP5/mp5_18.wav",SOUND_UNSCALABLE,84,5,60)},
			{"sreload", 29, Sound:Load3DSound("Sounds/Weapons/MP5/mp5_41.wav",SOUND_UNSCALABLE,84,5,60)},
			{"sreload_moving", 7, Sound:Load3DSound("Sounds/Weapons/MP5/mp5_18.wav",SOUND_UNSCALABLE,84,5,60)},
			{"sreload_moving", 29, Sound:Load3DSound("Sounds/Weapons/MP5/mp5_41.wav",SOUND_UNSCALABLE,84,5,60)},
		},
	},
...
-----------------------------------------------------------------------------------------------------
	...
	--		amin name		frame		soundfile
			...
			{"attack_melee5",	2,	Sound:Load3DSound("Sounds/mutants/cover/cover_melee3swipeF10.wav",SOUND_UNSCALABLE,255,2,200)},
...
-----------------------------------------------------------------------------------------------------
	MUTANT_STEALTH = {
		SoundEvents={
			...
			{"cwalkfwd",	4,			},
			{"cwalkfwd",	21,			},
			{"sreload", 6, Sound:Load3DSound("Sounds/Weapons/M4/M4_20.wav",SOUND_UNSCALABLE,100,5,60)},
			{"sreload", 28, Sound:Load3DSound("Sounds/Weapons/AG36/Ag36b_38.wav",SOUND_UNSCALABLE,100,5,60)},
			{"sreload_moving", 6, Sound:Load3DSound("Sounds/Weapons/M4/M4_20.wav",SOUND_UNSCALABLE,100,5,60)},
			{"sreload_moving", 28, Sound:Load3DSound("Sounds/Weapons/AG36/Ag36b_38.wav",SOUND_UNSCALABLE,100,5,60)},
