...
-- model & textures by OriK, Freestyle Productions
-- Script edit by xezon for Mercedes 280 SEL, Freestyle Productions
...
ox_Mercedes280SE = {
	...
	fileModel="objects/Vehicles/Mercedes280SE/m280se_model.cgf", 
	fileModelDead = "objects/Vehicles/Mercedes280SE/m280se_pieces.cgf",
	fileModelPieces = "objects/Vehicles/Mercedes280SE/m280se_pieces.cgf",
	...
	windows={
		...
		{
			fileName="Objects/vehicles/Mercedes280SE/m280se_window2.cgf",
			helperName="window2",
			entity=nil,
			nDamage=80, --default: 500
			fBreakImpuls=10, --default: 10
		},
		{
			fileName="Objects/vehicles/Mercedes280SE/m280se_window3.cgf",
			helperName="window3",
			entity=nil,
			nDamage=80, --default: 500
			fBreakImpuls=10, --default: 10
		...
		{
			fileName="Objects/vehicles/Mercedes280SE/m280se_window4.cgf",
			helperName="window4",
			entity=nil,
			nDamage=80, --default: 500
			fBreakImpuls=10, --default: 10
		...
		{
			fileName="Objects/vehicles/Mercedes280SE/m280se_window5.cgf",
			helperName="window5",
			entity=nil,
			nDamage=80, --default: 500
			fBreakImpuls=10, --default: 10
		...
		{
			fileName="Objects/vehicles/Mercedes280SE/m280se_window6.cgf",
			helperName="window6",
			entity=nil,
			nDamage=80, --default: 500
			fBreakImpuls=10, --default: 10
...
--///////////////////////     Revcounter Params      /////////////////////////////////
	...
	CarDef = {
		...
		engine_power = 450000, --60000 --100000 -- default using old mass 150000
		...
		hull1 = { mass=3410,flags=0,zoffset=-0.35,yoffset=-0.25	}, --mass: 2909-- default mass 4000
...
--		bEnterImmedeately = 0,	-- put AI in vehicle without approaching/animations
  ...
  --///////////////////////     Speedometer     /////////////////////////////////
	...
	driverT = {
		...
		out_ang = -90,
		message = "Press USE KEY to drive the Mercedes 280 SE",
	...
	passengersTT = {
		{
			...
			out_ang = 90,
			message = "Press USE KEY to enter passenger of Mercedes 280 SE",
			-- invehicle animations 
			animations = {
...
VC.CreateVehicle(ox_Mercedes280SE);

----------------------------------------------------------------------------------------------------------------------------
--
--
ox_Mercedes280SE.Client = {	
...
--
--
function ox_Mercedes280SE:OnReset()
...
--System:Log("\001  ox_Mercedes280SE RESET------------------------------------------ ");
...
--////////////////////////////////////////////////////////////////////////////////////////
function ox_Mercedes280SE:InitPhis()
	VC.InitGroundVehiclePhysics(self,self.fileModel);
end	

--////////////////////////////////////////////////////////////////////////////////////////
function ox_Mercedes280SE:InitClient()
	
	--disable player weapons
	self.cnt:SetWeaponName("none","");

	VC.InitSeats(self, ox_Mercedes280SE);
...
--	};
	...
	self.engine_start = Sound:Load3DSound("sounds\\vehicle\\m280se_sounds\\m280se_start.wav",0,100,13,300);
	self.engine_off = Sound:Load3DSound("sounds\\vehicle\\m280se_sounds\\m280se_off.wav",0,255,13,300);
...
--	};
	...
	self.clutch_sound = Sound:Load3DSound("sounds\\vehicle\\m280se_sounds\\m280se_gearchange.wav",0,255,13,300);
	
	self.idleengine = Sound:Load3DSound("SOUNDS\\Vehicle\\m280se_sounds\\m280se_idle.wav",0,70,13,300);
...
--////////////////////////////////////////////////////////////////////////////////////////
function ox_Mercedes280SE:InitServer()
...
--////////////////////////////////////////////////////////////////////////////////////////
function ox_Mercedes280SE:OnContactServer( player )
...
--////////////////////////////////////////////////////////////////////////////////////////
function ox_Mercedes280SE:OnContactClient( player )
...
function ox_Mercedes280SE:UpdateServer(dt)
...
--
--
function ox_Mercedes280SE:OnShutDown()
...
--
--
function ox_Mercedes280SE:OnSave(stm)
...
--
--
function ox_Mercedes280SE:OnLoad(stm)
...
--
--
function ox_Mercedes280SE:OnEventServer( id, params)
...
--
--
function ox_Mercedes280SE:DoEnter( puppet )
...
--
--
function ox_Mercedes280SE:AddDriver( puppet )
...
--System:Log("ox_Mercedes280SE:AddDriver");

--	self.driver = puppet;
	self.driverT.entity = puppet;

	if( VC.InitApproach( self, self.driverT )==0 ) then	
--System:Log("ox_Mercedes280SE:AddDriver  1");		
		self:DoEnter( puppet );
	end
	do return 1 end	
end
...
--
--
function ox_Mercedes280SE:AddGunner( puppet )
	return 0;
end
...
--
--
function ox_Mercedes280SE:AddPassenger( puppet )
--do return 0 end
...
function ox_Mercedes280SE:OnWrite( stm )
...
--
--
function ox_Mercedes280SE:OnRead( stm )
--local	id=0;	
--
--
--	id = stm:ReadInt();
...
--
--
function ox_Mercedes280SE:Event_EveryoneOut()
...
--
--
function ox_Mercedes280SE:Event_AIDriverIn()
...
--
--
function ox_Mercedes280SE:Event_AIDriverOut()
...
--
--
function ox_Mercedes280SE:RadioChatter()
end
...
--
--
function ox_Mercedes280SE:LoadPeople()
...
--System:Log("ox_Mercedes280SE LoadPeople  DRIVER IN ");
		AI:Signal(0, 1, "DRIVER_IN", self.id);
	end	
	
--System:Log("ox_Mercedes280SE LoadPeople loading");
...
--
--
function ox_Mercedes280SE:DropPeople()
...
--
--	to test-call reinf
function ox_Mercedes280SE:Event_Reinforcment( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_GoPatrol( params )

--System:Log("\001  ox_Mercedes280SE GoPath  ");
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_GoChase( params )
...
--
-- 
function ox_Mercedes280SE:Event_KillTriger( params )
...
--
-- to test
function ox_Mercedes280SE:Event_Grenade( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_GoPath( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_PausePath( params )

--System:Log("\001  ox_Mercedes280SE PausePath  ");
...
--
-----------------------------------------------------------------------------------------------------
function ox_Mercedes280SE:Event_LoadPeople( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_Wakeup( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_Enableox_Mercedes280SE( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_Disableox_Mercedes280SE( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_DriverIn( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_AIEntered( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_PlayerEntered( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_PathEnd( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_Activate( params )
...
----------------------------------------------------------------------------------------------------------------------------
--
--function ox_Mercedes280SE:Event_Hide( params )
--	self:Hide(1);
--end	

----------------------------------------------------------------------------------------------------------------------------
--
function ox_Mercedes280SE:Event_Unhide( params )
	self:Hide(0);
end	
...
function ox_Mercedes280SE:MakeAlerted()
end


--///////////////////////     Gauges     /////////////////////////////////
	
function ox_Mercedes280SE:OnUpdateCustomHud()
...
-------------------------------------------------------------------------------
function ox_Mercedes280SE:limit( val, vmin, vmax )
	if ( val < vmin ) then
		return vmin;
	end
	if ( val > vmax ) then
...
-------------------------------------------------------------------------------
function ox_Mercedes280SE:IsValidForGauge()
...
-------------------------------------------------------------------------------
function ox_Mercedes280SE:DrawSpeedo()
...
-------------------------------------------------------------------------------
function ox_Mercedes280SE:DrawRevo()
