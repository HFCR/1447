...
--	type = "Vehicle",
	...
	DamageParams = {
		...
		dmgBulletMP = 0.53,--if this value exist in multiplayer will be used this damage for every bullet , 
...
--	CurrentPosition = nil,
	...
	Properties = {		
		...
		bActive = 1, -- if vehicle is initially active or needs to be activated with Event_Activate first
		bEnabled  = 1,
		DisabledMessage = "",
		bLightsOn = 0,
