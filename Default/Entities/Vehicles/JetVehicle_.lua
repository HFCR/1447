...
JetVehicle = {
	...
	Properties = {
		...
		fileJet_P_Model = "Objects/vehicles/police_heli/police_heli_drivable.cgf",
		fileJet_P_Dead = "Objects/vehicles/police_heli/wreck_heli.cgf",
		fileJet_P_Gun = "Objects/vehicles/a_car/a_car_turret.cga",
		sJet_P_GunName = "MG",
		fStartDelay = 2,
		bDrawDriver = 0,
		damping = 0.1,
