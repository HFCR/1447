...
function Forklift:UpdateServer(dt)
	...
	if (self.driverT.entity) and (self.driverT.entity.cnt) then
		self.driverT.entity.cnt.weapon_busy = dt * 2;
	end
...
Forklift.Client = {
	...
	Alive = {
		...
		OnUpdate = function(self,dt)
			VC.UpdateClientAlive(self,dt)
			if (self.driverT.entity) and (self.driverT.entity.cnt) and (self.driverT.entity.cnt.weapon) then
				self.driverT.entity.cnt.weapon_busy = dt * 2;
				if (self.driverT.entity.cnt.first_person) then
					self.driverT.entity.cnt.drawfpweapon=nil;
				end
			end
		end,
