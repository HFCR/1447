--Blur effect layer for the smoke grenade By Marco Kögler (also Garbitos)
...
function SmokeBlur:OnActivate()
	...
	System:SetScreenFxParamFloat("ScreenBlur", "ScreenBlurColorRed", SmokeBlur.Red);
	System:SetScreenFxParamFloat("ScreenBlur", "ScreenBlurColorGreen", SmokeBlur.Green);
	System:SetScreenFxParamFloat("ScreenBlur", "ScreenBlurColorBlue", SmokeBlur.Blue);
